...
const CatalogProductCard = ({ href, product }: CatalogProductCardProps) => (
  <article className="flex flex-col overflow-hidden rounded-lg border border-sand-200 bg-white shadow-sm">
    ...
    <div className="flex flex-1 flex-col p-6">
      ...
      <Link
        href={href}
        className="mt-5 flex w-full items-center justify-center gap-2 rounded-full border border-brand-500 bg-transparent px-4 py-2.5 text-sm font-semibold text-brand-600 transition-all duration-300 hover:bg-brand-500 hover:text-white hover:shadow-md active:scale-95"
      >
